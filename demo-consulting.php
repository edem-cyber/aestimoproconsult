...
<body data-mobile-nav-style="classic">
    ...
    <section class="bg-very-light-gray">
        <div class="container">
            <div class="row justify-content-center mb-2">
                <div class="col-lg-7 text-center"
                    data-anime='{ "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <span class="fw-600 ls-1px fs-16 alt-font d-inline-block text-uppercase text-base-color">Business
                        news</span>
            ...
            <div class="row">
                <div class="col-12 p-md-0">
                    <ul class="blog-grid blog-wrapper grid-loading grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large"
                        data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay":100, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <li class="grid-sizer"></li>
                        <!-- start blog item -->
                        <li class="grid-item">
                            <div class="card border-0 border-radius-4px box-shadow-quadruple-large">
                                <div class="blog-image">
                                    <a href="demo-consulting-blog-single-modern.html" class="d-block"><img
                                            src="https://placehold.co/600x460" alt="" /></a>
                                </div>
                                <div class="card-body p-13 md-p-11">
                                    <a href="demo-consulting-blog-single-modern.html"
                                        class="card-title mb-15px alt-font fw-600 fs-20 text-dark-gray d-inline-block">Build
                                    ...
                                    <div
                                        ...
                                        <div class="me-auto">
                                            ...
                                            <div class="d-inline-block author-name">By <a
                                                    href="demo-consulting-news.html"
                                                    class="text-dark-gray text-decoration-line-bottom fw-600">Den
                                                    viliamson</a></div>
                                        </div>
                                        <div class="like-count fs-15 fw-600">
                                            <a href="demo-consulting-blog-single-modern.html"><i
                                                    class="fa-regular fa-heart text-base-color"></i><span
                                                    class="text-dark-gray align-middle">65</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="grid-item">
                            <div class="card border-0 border-radius-4px box-shadow-quadruple-large">
                                ...
                                <div class="card-body p-13 md-p-11">
                                    <a href="demo-consulting-blog-single-modern.html"
                                        class="card-title mb-15px alt-font fw-600 fs-20 text-dark-gray d-inline-block">How
                                        to bring the season into your great work</a>
                                    <p>Lorem ipsum has been industry standard dummy text ever...</p>
                                    <div
                                        class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-16">
                                        <div class="me-auto">
                                            ...
                                            <div class="d-inline-block author-name">By <a
                                                    href="demo-consulting-news.html"
                                                    class="text-dark-gray text-decoration-line-bottom fw-600">Hugh
                                                    macleod</a></div>
                                        </div>
                                        <div class="like-count fs-15 fw-600">
                                            <a href="demo-consulting-blog-single-modern.html"><i
                        ...
                        <li class="grid-item">
                            <div class="card border-0 border-radius-4px box-shadow-quadruple-large">
                                ...
                                <div class="card-body p-13 md-p-11">
                                    <a href="demo-consulting-blog-single-modern.html"
                                        class="card-title mb-15px alt-font fw-600 fs-20 text-dark-gray d-inline-block">Be
                                    ...
                                    <div
                                        ...
                                        <div class="me-auto">
                                            ...
                                            <div class="d-inline-block author-name">By <a
                                                    href="demo-consulting-news.html"
                                                    class="text-dark-gray text-decoration-line-bottom fw-600">Walton
                                                    smith</a></div>
                                        </div>
                                        <div class="like-count fs-15 fw-600">
                                            <a href="demo-consulting-blog-single-modern.html"><i
                                                    class="fa-regular fa-heart text-base-color"></i><span
                                                    class="text-dark-gray align-middle">30</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- end section -->
    <!-- start section -->
    <section class="pt-4 pb-4 cover-background" style="background-image:url('https://placehold.co/1920x408');">
        <div class="opacity-extra-medium bg-gradient-black-dark-orange"></div>
