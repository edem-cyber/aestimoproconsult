...
<head>
    <title>About Aestimo Pro Consult - Professional Accounting & Tax Advisory Services</title>
    <meta charset="utf-8">
...
<body data-mobile-nav-style="classic">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center small-screen">
                <div class="col-lg-6 col-md-8 position-relative text-center page-title-extra-small"
                    ...
                    <h2 class="mb-0 text-white alt-font ls-minus-2px text-shadow-double-large fw-500">About Our Company
                    </h2>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center text-lg-start">
                <div class="col-xl-5 col-lg-6 md-mb-30px xs-mb-25px">
                    <h2 class="fw-600 text-dark-gray ls-minus-2px mb-0"
                        ...
                        Building partnerships, looking beyond short-term advisor-client relationships with shared
                        commitment to long-term success.</h2>
                </div>
                <div class="col-lg-6 offset-xl-1">
                    <p class="w-90 sm-w-100 mx-auto mx-lg-0"
                        data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        Aestimo Pro Consult is a registered partnership for management consultancy, tax and
                        non-assurance services, licensed by the Chartered Institute of Taxation Ghana (CITG License:
                        CTPF D/00013). Founded with a commitment to excel in various professional services, we
                        specialize in management, IT, accounting, tax, financial control and business advisory,
            ...
            <div class="row justify-content-center align-items-center mt-5 md-mt-10">
                <div class="col-xl-4 col-lg-3 col-md-4 sm-mb-35px"
                    ...
                    <div class="row align-items-center mb-50px sm-mb-35px">
                        ...
                        <div class="col-7 col-xl-7 col-md-12 last-paragraph-no-margin text-md-end text-xl-start">
                            <span class="fs-20 text-dark-gray fw-600 alt-font">Company founded</span>
                            <p>Established our firm</p>
                        </div>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="row align-items-center">
                        <div class="col-5 col-xl-5 col-md-12 text-end">
                            <h2 class="alt-font fw-600 text-dark-gray ls-minus-2px mb-0">10+</h2>
                        </div>
                        <div class="col-7 col-xl-7 col-md-12 last-paragraph-no-margin text-md-end text-xl-start">
                            <span class="fs-20 text-dark-gray fw-600 alt-font">Years experience</span>
                ...
                <div class="col-xl-4 col-lg-6 col-md-4 text-center animation-float sm-mb-65px"
                    ...
                    <img class="border-radius-100 w-350px" src="https://placehold.co/485x485" alt="" />
                </div>
                <div class="col-xl-4 col-lg-3 col-md-4"
                    ...
                    <div class="row align-items-center mb-50px sm-mb-35px">
                        <div class="col-5 col-xl-5 col-md-12 text-end text-xl-end text-md-start">
                            <h2 class="alt-font fw-600 text-dark-gray ls-minus-2px mb-0">5+</h2>
                        </div>
                        <div class="col-7 col-xl-7 col-md-12 last-paragraph-no-margin text-md-start text-xl-end">
                            <span class="fs-20 text-dark-gray fw-600 alt-font">Expert team</span>
                    ...
                    <div class="row align-items-center">
                        <div class="col-5 col-xl-5 col-md-12 text-end text-xl-end text-md-start">
                            <h2 class="alt-font fw-600 text-dark-gray ls-minus-2px mb-0">100%</h2>
                        </div>
                        <div class="col-7 col-xl-7 col-md-12 last-paragraph-no-margin text-md-start text-xl-end">
                            <span class="fs-20 text-dark-gray fw-600 alt-font">Client focus</span>
        ...
        <div class="container">
            <div class="row align-items-center">
                                ...
                                <div class="feature-box hover-box dark-hover last-paragraph-no-margin">
                                    <div class="content-slide-up content-scale pt-17 pb-17 ps-10 pe-10 sm-p-15">
                                        ...
                                        <div class="feature-box-content">
                                            <span
                                                class="d-inline-block alt-font text-dark-gray fs-20 fw-600">Excellence</span>
                                            <p class="lh-28 text-visible text-light-opacity w-80 mx-auto sm-w-100">
                                                We deliver on promises and exceed client expectations by fostering
                                                innovation, continuous learning, and creative problem-solving.</p>
                                        </div>
                            ...
                            <div
                                ...
                                <div class="feature-box hover-box dark-hover last-paragraph-no-margin">
                                    <div class="content-slide-up content-scale pt-17 pb-17 ps-10 pe-10 sm-p-15">
                                        ...
                                        <div class="feature-box-content">
                                            <span
                                                class="d-inline-block alt-font text-dark-gray fs-20 fw-600">Passion</span>
                                            <p class="lh-28 text-visible text-light-opacity w-80 mx-auto sm-w-100">
                                                Our intense and success-driven approach involves integrating emotions
                                                into decision-making, fostering deep emotional connection.</p>
                                        </div>
                                        <div class="feature-box-overlay bg-base-color"></div>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="feature-box hover-box dark-hover last-paragraph-no-margin">
                                    <div class="content-slide-up content-scale pt-17 pb-17 ps-10 pe-10 sm-p-15">
                                        ...
                                        <div class="feature-box-content">
                                            <span
                                                class="d-inline-block alt-font text-dark-gray fs-20 fw-600">Quality</span>
                                            <p class="lh-28 text-visible text-light-opacity w-80 mx-auto sm-w-100">
                                                Dedicated to the highest quality in our work, our staff brings extensive
                                                experience from leading professional firms and industries.</p>
                                        </div>
                                        <div class="feature-box-overlay bg-base-color"></div>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="feature-box hover-box dark-hover last-paragraph-no-margin">
                                    <div class="content-slide-up content-scale pt-17 pb-17 ps-10 pe-10 sm-p-15">
                                        ...
                                        <div class="feature-box-content">
                                            <span
                                                class="d-inline-block alt-font text-dark-gray fs-20 fw-600">Diligence</span>
                                            <p class="lh-28 text-visible text-light-opacity w-80 mx-auto sm-w-100">
                                                Focused on building trust and enhancing value, we leverage industry
                                                knowledge and professional expertise to understand client needs.</p>
                                        </div>
                                        <div class="feature-box-overlay bg-base-color"></div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-5 offset-lg-1 text-center text-lg-start"
                    data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                    <h2 class="alt-font fw-600 text-dark-gray ls-minus-2px">The Aestimo Pro Consult Advantage</h2>
                    <p class="w-90 xs-w-100 mx-auto mx-lg-0"><strong>Professional Network:</strong> Education from top
                        global institutions with extensive experience from leading companies in Africa and beyond.
                        <strong>Licensed & Certified:</strong> Registered and licensed by CITG (License: CTPF D/00013)
                        with a team of chartered accountants, chartered tax professionals and finance professionals.
    ...
    <section class="bg-very-light-gray pt-0">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 text-center justify-content-center align-items-center clients-style-06"
                data-anime='{"el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                <!-- start client item -->
                <div class="col client-box text-center md-mb-40px">
                    <a href="#"><img src="images/logo-logitech.svg" class="h-40px" alt=""></a>
                </div>
                <!-- end client item -->
                <!-- start client item -->
                <div class="col client-box text-center md-mb-40px">
                    <a href="#"><img src="images/logo-amazon.svg" class="h-40px" alt=""></a>
                </div>
                <!-- end client item -->
                <!-- start client item -->
                <div class="col client-box text-center xs-mb-40px">
                    <a href="#"><img src="images/logo-walmart.svg" class="h-40px" alt=""></a>
                </div>
                <!-- end client item -->
                <!-- start client item -->
                <div class="col client-box text-center">
                    <a href="#"><img src="images/logo-yahoo.svg" class="h-40px" alt=""></a>
                </div>
                <!-- end client item -->
            </div>
        </div>
