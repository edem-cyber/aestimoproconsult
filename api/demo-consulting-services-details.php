...
<body data-mobile-nav-style="classic">
    ...
    <section class="page-title-big-typography bg-dark-gray ipad-top-space-margin xs-py-0"
        data-parallax-background-ratio="0.5" style="background-image: url(https://placehold.co/1920x1050)">
        <div class="opacity-light bg-dark-gray"></div>
        <div class="container">
            <div class="row align-items-center justify-content-center small-screen">
                <div class="col-lg-7 col-md-8 position-relative text-center page-title-extra-small"
                    ...
                    <h2 class="mb-0 text-white alt-font ls-minus-2px text-shadow-double-large fw-500">Financial advisory
                    </h2>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-9 md-mb-50px">
                    <figure class="position-relative m-0 border-radius-5px overflow-hidden"
                        ...
                        <figcaption
                            ...
                            <h2 class="text-dark-gray fw-700 ls-minus-3px sm-ls-minus-2px vertical-counter d-inline-flex mb-0 text-nowrap border-end border-1 border-color-extra-medium-gray pe-20px me-20px"
                                data-to="85"></h2>
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6 col-md-9"
                    ...
                    <p class="w-90 lg-w-100 md-mx-auto mb-35px">Lorem ipsum dolor sit amet consectetur elit adipiscing
                        elit do eiusmod tempor incididunt ut labore dolore.</p>
                    <div class="row row-cols-1 justify-content-center"
                        ...
                        <div class="col icon-with-text-style-01 mb-7">
                            <div class="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
                                ...
                                <div class="feature-box-content">
                                    <span class="fs-20 md-fs-19 fw-600 text-dark-gray d-block mb-5px">Business are our
                                        speciality</span>
                                    <p>Lorem ipsum simply dummy printing type setting industry tempor sit labore.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col icon-with-text-style-01">
                            <div class="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
                                ...
                                <div class="feature-box-content">
                                    <span class="fs-20 md-fs-19 fw-600 text-dark-gray d-block mb-5px">Investments in
                                        startups</span>
                                    <p>Lorem ipsum simply dummy printing type setting industry tempor sit labore.</p>
                                </div>
                            </div>
    ...
    <!-- end section -->
    <!-- start section -->
    <section class="pt-0 border-bottom border-color-transparent-dark-very-light"
        ...
        <div class="container">
            <div class="row mb-45px md-mb-30px">
                <div class="col-12 text-center">
                    <span class="fs-26 fw-500 ls-minus-1px text-dark-gray">Trusted by the world's fastest growing
                        companies</span>
                </div>
            </div>
    ...
    <section class="overflow-hidden">
        <div class="container">
            <div class="row mb-7 justify-content-center">
                <div class="col-lg-4 md-mb-60px sm-mb-45px text-center text-lg-start"
                    data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                    <h3 class="text-dark-gray fw-600 ls-minus-2px w-80 xl-w-100 mb-15px">What include in the service?
                    </h3>
                    <p class="w-80 xl-w-100">Lorem ipsum dolor amet consectetur adipiscing dolore magna tempor.</p>
                    <a href="demo-consulting-contact.html"
                        class="btn btn-medium btn-dark-gray btn-box-shadow btn-round-edge">Get started now!</a>
                </div>
                <div class="col-lg-8">
                    <div class="row row-cols-1 row-cols-md-2 justify-content-center"
                        ...
                        <div class="col icon-with-text-style-01 mb-6 xs-mb-30px">
                            <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                                <div class="feature-box-icon">
                                    <i class="line-icon-Bar-Chart2 icon-extra-large text-base-color"></i>
                                </div>
                                <div class="feature-box-content">
                                    <span class="fs-20 fw-600 text-dark-gray d-block mb-5px">Market research</span>
                                    <p>Lorem ipsum is simply dummy printing type setting it.</p>
                                </div>
                            </div>
                        </div>
                        <!-- end features box item -->
                        ...
                        <div class="col icon-with-text-style-01 mb-6 xs-mb-30px">
                            <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                                <div class="feature-box-icon">
                                    <i class="line-icon-Basket-Coins icon-extra-large text-base-color"></i>
                                </div>
                                <div class="feature-box-content">
                                    <span class="fs-20 fw-600 text-dark-gray d-block mb-5px">Services planing</span>
                                    <p>Lorem ipsum is simply dummy printing type setting it.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col icon-with-text-style-01 sm-mb-6 xs-mb-30px">
                            <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                                <div class="feature-box-icon">
                                    <i class="line-icon-Cursor-Click2 icon-extra-large text-base-color"></i>
                                </div>
                                <div class="feature-box-content">
                                    <span class="fs-20 fw-600 text-dark-gray d-block mb-5px">Google analyzing</span>
                                    <p>Lorem ipsum is simply dummy printing type setting it.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col icon-with-text-style-01">
                            <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                                <div class="feature-box-icon">
                                    <i class="line-icon-Archery-2 icon-extra-large text-base-color"></i>
                                </div>
                                <div class="feature-box-content">
                                    <span class="fs-20 fw-600 text-dark-gray d-block mb-5px">Final approach</span>
                                    <p>Lorem ipsum is simply dummy printing type setting it.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row"
                ...
                <div class="col-12 fs-22 fw-500 ls-minus-1px text-dark-gray text-center">
                    For any queries on financial advisory services, write us at <a
    ...
    <section class="p-0 bg-dark-gray">
        <div class="container-fluid p-0">
            <div class="row justify-content-center g-0">
                <div class="col-lg-6 md-h-550px sm-h-400px">
                    <div class="h-100 cover-background" style="background-image: url(https://placehold.co/960x678)"
                        data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                    </div>
                </div>
                <div class="col-lg-6 ps-8 pe-7 pt-6 pb-6 lg-p-6 sm-p-10"
                    data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 100, "easing": "easeOutQuad" }'>
                    <h2 class="alt-font fw-500 text-white ls-minus-2px w-80 xl-w-100 mb-25px">Benefits of our financial
                        advisor.</h2>
                    <p class="w-65 xl-w-85 lg-w-100 mb-30px">There are many variations of passages of available but the
                        majority have suffered alteration some form humou words which don't look believable.</p>
                    <!-- start features box item -->
                    <div class="icon-with-text-style-08 mb-15px">
                        <div class="feature-box feature-box-left-icon-middle">
                            <div
                                class="feature-box-icon feature-box-icon-rounded w-45px h-45px rounded-circle border border-2 border-color-transparent-white-light box-shadow-large me-15px">
                                <i class="fa-solid fa-check icon-very-small text-white"></i>
                            </div>
                            <div class="feature-box-content">
                                <span class="fs-18 lh-28 fw-500 d-block text-white">More predictable income for your
                                    firm.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="icon-with-text-style-08 mb-15px">
                        <div class="feature-box feature-box-left-icon-middle">
                            ...
                            <div class="feature-box-content">
                                <span class="fs-18 lh-28 fw-500 d-block text-white">Lets your brokers focus on what they
                                    do best.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="icon-with-text-style-08">
                        <div class="feature-box feature-box-left-icon-middle">
                            ...
                            <div class="feature-box-content">
                                <span class="fs-18 lh-28 fw-500 d-block text-white">Better & more plentiful, investment
                                    options.</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row mb-6">
                <div class="col-xl-5 col-lg-6 md-mb-40px"
                    data-anime='{ "el": "childs", "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                    <h2 class="text-dark-gray fw-600 ls-minus-2px mb-15px">Transform your business now.</h2>
                        ...
                        <div class="accordion-item active-accordion">
                            <div class="accordion-header border-bottom border-color-extra-medium-gray">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-01"
                                    ...
                                    <div class="accordion-title mb-0 position-relative text-dark-gray">
                                        <i class="fa-solid fa-angle-down icon-small"></i><span class="fs-20 fw-600">How
                                            will my financial planning be done?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="accordion-style-02-01" class="accordion-collapse collapse show"
                                ...
                                <div
                                    ...
                                    <p>Lorem ipsum is simply dummy text of the printing industry industry typesetting
                                        industry lorem.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-extra-medium-gray">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-02"
                                    ...
                                    <div class="accordion-title mb-0 position-relative text-dark-gray">
                                        <i class="fa-solid fa-angle-right icon-small"></i><span
                                            class="fs-20 fw-600">What
                                            is your investment philosophy?</span>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-03"
                                    aria-expanded="false" data-bs-parent="#accordion-style-02">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray">
                                        <i class="fa-solid fa-angle-right icon-small"></i><span class="fs-20 fw-600">Do
                                            we really need a financial planner?</span>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="atropos-scale">
                            <div class="atropos-rotate">
                                <div class="atropos-inner">
                                    <img src="https://placehold.co/960x762" alt="" class="w-100 border-radius-6px" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center"
                ...
                <div class="col-12 fs-22 fw-500 ls-minus-1px text-dark-gray text-center">
                    Save your precious time and effort spent for finding a solution. <a
                        class="text-dark-gray text-decoration-line-bottom d-inline-block"
                        href="demo-consulting-contact.html">Contact us now</a>
                </div>
            </div>
        </div>
    </section>
    <!-- end section -->
    <!-- start section -->
    <section class="bg-very-light-gray background-position-right-top background-no-repeat"
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-10 contact-form-style-03 md-mb-50px sm-mb-30px"
                    ...
                    <div class="p-14 lg-p-11 border-radius-6px bg-dark-gray h-100">
                        <h3 class="fw-500 alt-font text-white mb-30px md-mb-15px ls-minus-1px">Get a free quote?</h3>
                        <!-- start contact form -->
                        <form action="api/contact-form" method="post">
                            ...
                            <div class="position-relative form-group form-textarea mt-15px mb-25px">
                                ...
                                <button
                                    class="btn btn-medium btn-base-color mt-30px submit w-100 btn-round-edge btn-box-shadow"
                                    type="submit">Submit now</button>
                                <div class="form-results mt-20px d-none"></div>
                            </div>
                            <span class="fs-15 lh-24 text-medium-gray opacity-8 d-block">I understand that my data will
                                be hold securely in accordance with the privacy policy.</span>
                        </form>
                        <!-- end contact form -->
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1 col-md-10 text-center text-lg-start"
                    ...
                    <span class="fs-20 fw-500 text-base-color d-block mb-20px">A few good reasons</span>
                    <h2 class="fw-600 text-dark-gray ls-minus-2px mb-35px">Here is what our clients have to say.</h2>
                    <div class="swiper position-relative magic-cursor"
                        ...
                        <div class="swiper-wrapper mb-50px lg-mb-35px">
                            ...
                            <div class="swiper-slide review-style-08">
                                <p class="fs-18">This theme has a wide variety of options and a really good customer
                                    support. Some of the customizations are unlimited but even so the theme variety
                                    still gives lot of features while variety of options.</p>
                                <div class="mt-20px">
                                    <img class="rounded-circle w-95px h-95px me-15px" src="https://placehold.co/148x148"
                                        alt="">
                                    <div class="d-inline-block align-middle text-start">
                                        <div class="text-dark-gray fs-20 fw-600 ls-minus-05px">Alexander harvard</div>
                            ...
                            <!-- start text slider item -->
                            <div class="swiper-slide review-style-08">
                                <p class="fs-18">I've purchased several themes over the years and this theme, by far is
                                    absolutely amazing. It's built extremely well the back end was well thought out the
                                    design options are endless.</p>
                                <div class="mt-20px">
                                    <img class="rounded-circle w-95px h-95px me-15px" src="https://placehold.co/148x148"
                                        alt="">
                                    <div class="d-inline-block align-middle text-start">
                                        <div class="text-dark-gray fs-20 fw-600 ls-minus-05px">Shoko mugikura</div>
                                        <div class="review-star-icon fs-18">
                                            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                                                class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                                                class="bi bi-star-fill"></i>
                            ...
                            <!-- start text slider item -->
                            <div class="swiper-slide review-style-08">
                                <p class="fs-18">The theme is very valid and offers many possibilities of customization
                                    to adapt it to your needs, but the thing I got the most out of it was the
                                    relationship with the support team.</p>
                                <div class="mt-20px">
                                    <img class="rounded-circle w-95px h-95px me-15px" src="https://placehold.co/200x200"
                                        alt="">
                                    <div class="d-inline-block align-middle text-start">
                                        <div class="text-dark-gray fs-20 fw-600 ls-minus-05px">Leonel mooney</div>
                                        <div class="review-star-icon fs-18">
                                            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                                                class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                                                class="bi bi-star-fill"></i>
